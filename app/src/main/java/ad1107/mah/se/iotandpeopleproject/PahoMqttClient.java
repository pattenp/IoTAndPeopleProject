...
public class PahoMqttClient {
  ...
  private static final String USERNAME = "bunfuyzm";
  private static final String PASSWORD = "mZ2oRpLMvQYI";
  ...
  @NonNull private DisconnectedBufferOptions getDisconnectedBufferOptions() {
  ...
  @NonNull private MqttConnectOptions getMqttConnectionOption() {
  ...
  public void publishMessage(@NonNull MqttAndroidClient client, @NonNull String msg, int qos,
      @NonNull String topic) throws MqttException, UnsupportedEncodingException {
